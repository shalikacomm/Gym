      ...
      <div class="navbar navbar-default navbar-top">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html"><img alt="" src="assets_front/images/margo.png"></a>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-5"> 
              ...
              <div class="touch-slider" data-slider-navigation="true" data-slider-pagination="true">
                <div class="item"><img alt="" src="assets_front/images/about-01.jpg"></div>
                <div class="item"><img alt="" src="assets_front/images/about-02.jpg"></div>
                <div class="item"><img alt="" src="assets_front/images/about-03.jpg"></div>
              </div>
              <!-- End Touch Slider -->
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="team-member">
                ...
                <div class="member-photo">
                  <img alt="" src="assets_front/images/team/face_1.png" />
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="team-member">
                <!-- Memebr Photo, Name & Position -->
                <div class="member-photo">
                  <img alt="" src="assets_front/images/team/face_3.png" />
                            ...
                            <ul class="flickr-list">
                                <li>
                                    <a href="assets_front/images/flickr-01.jpg" class="lightbox">
                                        <img alt="" src="assets_front/images/flickr-01.jpg">
                                    </a>
                                </li>
                                <li>
                                    <a href="assets_front/images/flickr-02.jpg" class="lightbox">
                                        <img alt="" src="assets_front/images/flickr-02.jpg">
                                    </a>
                                </li>
                                <li>
