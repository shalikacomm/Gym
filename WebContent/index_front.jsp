    ...
    <div id="container">
            ...
            <div id="main-slide" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img class="img-responsive" src="assets_front/images/slider/bg1.jpg" alt="slider">
                    ...
                    <!--/ Carousel item end -->
                    <div class="item">
                        <img class="img-responsive" src="assets_front/images/slider/bg2.jpg" alt="slider">
                        <div class="slider-content">
                            <div class="col-md-12 text-center">
                                <h2 class="animated4">
                    ...
                    <!--/ Carousel item end -->
                    <div class="item">
                        <img class="img-responsive" src="assets_front/images/slider/bg3.jpg" alt="slider">
                        <div class="slider-content">
                            <div class="col-md-12 text-center">
        ...
        <div class="section full-width-portfolio" style="border-top:0; border-bottom:0; background:#fff;">
                ...
                <ul id="portfolio-list" data-animated="fadeIn">
                    <li>
                        <img src="assets_front/images/Portfolio-1/1.png" alt="" />
                    ...
                    <li>
                        <img src="assets_front/images/Portfolio-1/2.png" alt="" />
                        <div class="portfolio-item-content">
                    ...
                    <li>
                        <img src="assets_front/images/Portfolio-1/3.png" alt="" />
                        <div class="portfolio-item-content">
                    ...
                    <li>
                        <img src="assets_front/images/Portfolio-1/4.png" alt="" />
                        <div class="portfolio-item-content">
                    ...
                    <li>
                        <img src="assets_front/images/Portfolio-1/5.png" alt="" />
                        <div class="portfolio-item-content">
                    ...
                    <li>
                        <img src="assets_front/images/Portfolio-1/6.png" alt="" />
                        <div class="portfolio-item-content">
                    ...
                    <li>
                        <img src="assets_front/images/Portfolio-1/7.png" alt="" />
                        <div class="portfolio-item-content">
                            <span class="header">Monocle issue 69</span>
                            <p class="body">web develpment, design</p>
                        </div>
                    ...
                    <li>
                        <img src="assets_front/images/Portfolio-1/8.png" alt="" />
                        <div class="portfolio-item-content">
                            <span class="header">Monocle issue 69</span>
                            <p class="body">web develpment, design</p>
                        </div>
                    ...
                    <li>
                        <img src="assets_front/images/Portfolio-1/9.png" alt="" />
                        <div class="portfolio-item-content">
                            <span class="header">Monocle issue 69</span>
                            <p class="body">web develpment, design</p>
                        </div>
                    ...
                    <li>
                        <img src="assets_front/images/Portfolio-1/10.png" alt="" />
                        <div class="portfolio-item-content">
                            <span class="header">Monocle issue 69</span>
                            <p class="body">web develpment, design</p>
                        </div>
                    ...
                    <li>
                        <img src="assets_front/images/Portfolio-1/11.png" alt="" />
                        <div class="portfolio-item-content">
                            <span class="header">Monocle issue 69</span>
                            <p class="body">web develpment, design</p>
                        </div>
                    ...
                    <li>
                        <img src="assets_front/images/Portfolio-1/12.png" alt="" />
                        <div class="portfolio-item-content">
                            <span class="header">Monocle issue 69</span>
                            <p class="body">web develpment, design</p>
                        </div>
...
<div class="col-md-4">
  ...
  <!-- End Testimonials Carousel -->
        ...
        <div id="parallax-one" class="parallax" style="background-image:url(assets_front/images/parallax/bg-02.jpg);">
		...
		<div class="our-clients">
			<div class="clients-carousel custom-carousel touch-carousel navigation-3" data-appeared-items="5" data-navigation="true">
				...
				<div class="client-item item">
					<a href="#"><img src="assets_front/images/c1.png" alt="" /></a>
				</div>
				
				<!-- Client 2 -->
				<div class="client-item item">
					<a href="#"><img src="assets_front/images/c2.png" alt="" /></a>
				</div>
				
				<!-- Client 3 -->
				<div class="client-item item">
					<a href="#"><img src="assets_front/images/c3.png" alt="" /></a>
				</div>
				
				<!-- Client 4 -->
				<div class="client-item item">
					<a href="#"><img src="assets_front/images/c4.png" alt="" /></a>
				</div>
				
				<!-- Client 5 -->
				<div class="client-item item">
					<a href="#"><img src="assets_front/images/c5.png" alt="" /></a>
				</div>
				
				<!-- Client 6 -->
				<div class="client-item item">
					<a href="#"><img src="assets_front/images/c6.png" alt="" /></a>
				</div>
				
				<!-- Client 7 -->
				<div class="client-item item">
					<a href="#"><img src="assets_front/images/c7.png" alt="" /></a>
				</div>
				
				<!-- Client 8 -->
				<div class="client-item item">
					<a href="#"><img src="assets_front/images/c8.png" alt="" /></a>
				</div>
                ...
                <div class="row footer-widgets">
                    ...
                    <div class="col-md-3 col-xs-12">
                        <div class="footer-widget contact-widget">
                            <h4><img src="assets_front/images/footer-margo.png" class="img-responsive" alt="Footer Logo" /></h4>
