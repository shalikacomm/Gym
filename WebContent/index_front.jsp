				...
				<div class="container">
					...
					<div class="navbar-collapse collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							<li><a href="index_front.html">Home</a>
								<ul class="dropdown">
		...
		<section id="home">
			...
			<div id="main-slide" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					...
					<div class="item">
						<img class="img-responsive"
							src="assets_front/images/slider/bg2.jpg" alt="slider" style="max-height: 800px; max-width: 1600px;">
						<div class="slider-content">
							<div class="col-md-12 text-center">
								<h2 class="animated4">
				...
				<!-- Controls -->
				<a class="left carousel-control" href="#main-slide"
					data-slide="prev"> <span><i class="fa fa-angle-left"></i></span>
