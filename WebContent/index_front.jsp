	...
	<div id="container">
						...
						<div class="slider-content">
							<div class="col-md-12 text-center">
								...
								<p class="animated4"
									...
									<a href="#" class="slider btn btn-system btn-large"
		...
		<div class="row" style="">
			<div class="col-md-6 service-box service-center"
				style="background-image: url('${pageContext.request.contextPath}/assets_front/images/img1.jpg'); height:600px; background-repeat: no-repeat;">
			...
			<div class="col-md-6 service-box service-center"
				style="background-image: url('${pageContext.request.contextPath}/assets_front/images/img2.jpg'); height:650px; background-repeat: no-repeat;">
				<div class="service-content" style="">
		...
		<div class="section purchase">
			<div class="container">
				...
				<div class="section-video-content text-center">
					...
					<!-- Start Buttons -->
					<a href="#" class="btn-system btn-large"><i class="fa fa-tasks"></i>
						Check Out Features</a> <a href="#"
						class="btn-system btn-large btn-wite"><i
						class="fa fa-download"></i>Login to Purchase Items</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn" data-animation-delay="06">
                            <div class="team-member modern">
                                <!-- Memebr Photo, Name & Position -->
                                <div class="member-photo">
                                    <img alt="" src="${pageContext.request.contextPath}/assets_front/images/team_members/instructor3.jpg" />
