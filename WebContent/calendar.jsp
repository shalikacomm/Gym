                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="box">
								...
								<div class="col-sm-3">
									<div class="form-group">
										<input id="user_cal" readonly="readonly" type="hidden"
											class="form-control" name="first_name" value="${user_id}"
											placeholder="First Name" />
...
//                    defaultDate: '2016-09-12',
                    ...
                    events: 'AttenCon?action=getAttendance&user_id='+user_id,
